...
public interface AdminDAOInterface {
	 ...
	 */
	int addProfessor(Professor professor) throws AlreadyRegisteredUserException, RegistrationFailedException;
	 ...
	 */
	void addCatalog(int catlogId, String catalogName);
	...
	/**
	 * To view the student accounts in queue for admin approval
	 *
	 * @return list of pending student's approval
	 */
